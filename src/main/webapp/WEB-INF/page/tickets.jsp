                        ...
                        <div class="col">
                                        ...
                                        <form id="filter">
                                            <div class="row">
                                                <div class="col-md-4 text-left">
                                                    <h6><spring:message code="tickets.filter.parameter"/>:</h6>
                                                    <div class="form-group">
                                                        <div class="row custom-switch custom-control">
                                                            <div class="col-md-12">
                                                                <input type="checkbox" id="filt_active" name="active" class="custom-control-input">
                                                                <label class="custom-control-label text-muted" for="filt_active"><spring:message code="tickets.filter.active"/></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="row custom-switch custom-control">
                                                            <div class="col-md-12">
                                                                ...
                                                                <label class="custom-control-label text-muted" for="filt_equipment"><spring:message code="tickets.filter.equipment"/></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 text-left">
                                                    <h6><spring:message code="tickets.filter.time"/>:</h6>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-5 mt-auto mb-auto">
                                                                <label class="form-label text-muted m-auto"><spring:message code="tickets.filter.from"/></label>
                                                            </div>
                                                            <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-5 mt-auto mb-auto">
                                                                <label class="form-label text-muted m-auto"><spring:message code="tickets.filter.to"/></label>
                                                            </div>
                                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-4 text-left">
                                                    <h6><spring:message code="tickets.filter.date"/>:</h6>
                                                    <div class="form-group">
                                                        <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title"><spring:message code="tickets.title"/></h5>
                                    <h6 class="card-subtitle text-muted"><spring:message code="tickets.subtitle"/></h6>
                                </div>
                                <div class="card-body">
                                    <div class="col text-left mb-2">
                        ...
                        <form class="" id="ticketForm">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalTitle"><spring:message code="tickets.add"/></h5>
                                ...
                                <div class="m-3 modal-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.type"/></label>
                                                <select id="select" name="pass" class="form-control">
                                                    <option selected><spring:message code="tickets.type.pass"/></option>
                                                    <option><spring:message code="tickets.type.abonement"/></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.name"/></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.parameter"/></label>
                                                <div class="custom-switch custom-control"><input type="checkbox" id="onlyActive" name="enable" checked class="custom-control-input"><label class="custom-control-label" for="onlyActive"><spring:message code="tickets.active"/></label></div>
                                                <div class="custom-switch custom-control"><input type="checkbox" id="onlyWithEquipment" name="equipment" class="custom-control-input"><label class="custom-control-label" for="onlyWithEquipment"><spring:message code="tickets.equipment"/></label></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.duration.long"/></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.interval.long"/></label>
                                                <div class="row">
                                                    <div class="col-sm-5">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.dynamic.duration"/></label>
                                                <div class="row">
                                                    <div class="row form-group"><label class="text-md-right col-sm-6 col-form-label"><spring:message code="tickets.day"/>:</label>
                                                        <div class="col-sm-4"><input name="day" type="number" class="form-control" value = "0" min="0">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group"><label class="text-md-right col-sm-6 col-form-label"><spring:message code="tickets.month.br"/>:</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.fix.duration"/></label>
                                                <div class="row">
                                                    <div class="row form-group"><label class="text-md-right col-sm-4 col-form-label"><spring:message code="tickets.start"/>:</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="row form-group"><label class="text-md-right col-sm-5 col-form-label"><spring:message code="tickets.end"/>:</label>
                                                        <div class="col-sm-7 m-auto">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6"><spring:message code="tickets.cost"/></label>
                                                <div class="row">
                                                    <div class="row form-group"><label class="text-md-right col-sm-5 col-form-label"><spring:message code="tickets.cost.day"/></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="h6">&nbsp;</label>
                                                <div class="row">
                                                    <div class="row form-group"><label class="text-md-right col-sm-5 col-form-label"><spring:message code="tickets.cost.weekendcost"/></label>
                                                        <div class="col-sm-5 m-auto">
