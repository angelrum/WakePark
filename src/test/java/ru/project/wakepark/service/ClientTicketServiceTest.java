...
class ClientTicketServiceTest extends AbstractServiceTest <ClientTicket> {
    ...
    @Test
    void getByClient() {
        CL_TICKET_MATCHER.assertMatch(service.getAllByClient(WAKE_ID1, CLIENT_ID1), List.of(CL_TICKET1, CL_TICKET2, CL_TICKET4));
    }

    @Test
    void getByClientActive() {
        CL_TICKET_MATCHER.assertMatch(service.getAllByClientAndActive(WAKE_ID1, CLIENT_ID1), List.of(CL_TICKET1, CL_TICKET2));
    }

    @Test
    void getByTicketZero() {
        Assertions.assertThat(ClientTicketUtil.getInstance().getByTicket(service.getAllByClientAndActive(WAKE_ID1, CLIENT_ID1),
    ...
    @Test
    void getByTicket() {
        CL_TICKET_MATCHER.assertMatch(ClientTicketUtil.getInstance().getByTicket(service.getAllByClient(WAKE_ID1, CLIENT_ID1), TicketTestData.TICKET2), List.of(CL_TICKET1, CL_TICKET2));
    }
    ...
    void createByList() {
        ...
        CL_TICKET_MATCHER.assertMatch(service.getAllByClient(WAKE_ID1, CLIENT_ID2), expected);
    }

    @Test
    void createByQuantityDifference() {
        service.createOrDelete(WAKE_ID1, CLIENT2, TICKET1, UserTestData.USER_ID1, CLT_NEWCOUNT_CL2);
        List<ClientTicket> ctl = service.getAllByClientAndActive(WAKE_ID1, CLIENT_ID2);
    ...
    void deleteByQuantityDifference() {
        List<ClientTicket> all = service.getAllByClientAndActive(WAKE_ID1, CLIENT_ID1);
        ...
        List<ClientTicket> actual = service.getAllByClientAndActive(WAKE_ID1, CLIENT_ID1);
